    ...
    try:
        ...
        try:
            ...
            if "429" in error_msg or "RESOURCE_EXHAUSTED" in error_msg or "quota" in error_msg.lower():
                print("Primary model rate limit hit. Falling back to Gemini 3 Flash...")
                ...
                try:
                    ...
                    raise ValueError("Both primary and backup models are exhausted.")
            else:
                raise primary_e # If it's a different network error, pass it down
